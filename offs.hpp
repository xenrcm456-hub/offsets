...
// Mirrors latest Offsets.hpp from imtheo.lol (version-390ba09e7e944154 - 26/04/2026)
namespace offs {
    // Core / Pointers
    inline constexpr uintptr_t EnableLoadModule = 0x751fe08;      // still valid
    ...
    // Scripts
    inline constexpr uintptr_t lscriptBc = 0x1b8;         // LocalScript::Hash (or use ByteCode::Pointer)
    inline constexpr uintptr_t mscriptBc = 0x150;         // ModuleScript still valid in most cases

    // Common Properties
    inline constexpr uintptr_t Adornee = 0x108;           // updated
    inline constexpr uintptr_t Anchored = 0xf6;           // BasePart::Locked style flags (use proper Primitive flags)
    ...
    inline constexpr uintptr_t CFrame = 0xc0;             // BasePart / Primitive
    inline constexpr uintptr_t Camera = 0x490;            // Workspace::CurrentCamera (still same)
    ...
    inline constexpr uintptr_t CanCollide = 0xf5;         // BasePart flags area
    inline constexpr uintptr_t CanCollideMask = 0x8;
    inline constexpr uintptr_t CanTouch = 0xf5;           // same area
    ...
    inline constexpr uintptr_t DataModelDeleterPointer = 0x7A1D390; // keep if you use it
    ...
    inline constexpr uintptr_t Dimensions = 0xA60;        // still used in some VisualEngine paths
    ...
    inline constexpr uintptr_t Gravity = 0x1D8;           // still valid
    ...
    inline constexpr uintptr_t MaterialType = 0x1b1;      // BasePart::Shape area (check)
    inline constexpr uintptr_t MaxHealth = 0x1b4;
    inline constexpr uintptr_t MaxSlopeAngle = 0x1b8;
    inline constexpr uintptr_t MeshPartColor3 = 0x194;    // BasePart::Color3
    inline constexpr uintptr_t MeshPartTexture = 0x328;   // updated
    ...
    inline constexpr uintptr_t MouseSensitivity = 0x7c387f0; // updated in recent dumps
    inline constexpr uintptr_t MoveDirection = 0x158;
    inline constexpr uintptr_t NameDisplayDistance = 0x1bc;  // updated
    ...
    inline constexpr uintptr_t PlayerMouse = 0x1158;         // updated
    ...
    inline constexpr uintptr_t ReadOnlyGravity = 0x9c0;      // updated
    inline constexpr uintptr_t RenderJobToDataModel = 0x1c0; // updated
    ...
    inline constexpr uintptr_t RootPartR15 = 0x478;
    inline constexpr uintptr_t RootPartR6 = 0x478;
    inline constexpr uintptr_t Rotation = 0xc8;              // still used
    ...
    inline constexpr uintptr_t WorkspaceToWorld = 0x408;     // updated
