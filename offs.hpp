#pragma once
#include <Windows.h>
// Mirrors `Offsets.hpp` / `FFlags.hpp` (version-390ba09e7e944154) for symbols used by SelpExt.
namespace offs {
    ...
    inline constexpr uintptr_t fakeDataModelToDataModel = 0x1d0;       // updated
    inline constexpr uintptr_t children = 0x78;                        // unchanged
    inline constexpr uintptr_t childrenEnd = 0x8;                      // unchanged
    inline constexpr uintptr_t name = 0xb0;                            // unchanged
    inline constexpr uintptr_t value = 0xd0;                           // unchanged
    inline constexpr uintptr_t classDesc = 0x18;                       // unchanged
    inline constexpr uintptr_t classDescToName = 0x8;                  // unchanged
    ...
    inline constexpr uintptr_t AutoJumpEnabled = 0x1D8;                // updated
    ...
    inline constexpr uintptr_t EvaluateStateMachine = 0x1DC;           // updated
    ...
    inline constexpr uintptr_t RootPartR15 = 0x478;                    // updated
